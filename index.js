...
shops.addEventListener("click", ()=>{
    shops.style.color="rgba(0, 0, 0, 1)";
    reviews.style.color="rgb(113, 0, 0)";
    blogs.style.color="rgb(113, 0, 0)";
    contacts.style.color="rgb(113, 0, 0)";
...
blogs.addEventListener("click", ()=>{
    blogs.style.color="rgba(0, 0, 0, 1)";
    reviews.style.color="rgb(113, 0, 0)";
    shops.style.color="rgb(113, 0, 0)";
    contacts.style.color="rgb(113, 0, 0)";
})

contacts.addEventListener("click", ()=>{
    contacts.style.color="rgba(0, 0, 0, 1)";
    reviews.style.color="rgb(113, 0, 0)";
    blogs.style.color="rgb(113, 0, 0)";
    shops.style.color="rgb(113, 0, 0)";
})
